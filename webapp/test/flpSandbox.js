		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#namespacemyui5projectv1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"namespacemyui5projectv1-display": {
								"semanticObject": "namespacemyui5projectv1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=namespace.myui5projectv1",
									"url": sap.ui.require.toUrl("namespace/myui5projectv1")
								}
							}
						}
					}
