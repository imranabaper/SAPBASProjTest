sap.ui.define([
	"sap/ui/test/Opa5",
	"namespace/myui5projectv1/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("namespace.myui5projectv1.test.integration.arrangements.Startup", {
