sap.ui.define([
	...
	return Opa5.extend("namespace.myui5projectv1.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["namespace/myui5projectv1/localService/mockserver"], function (mockserver) {
